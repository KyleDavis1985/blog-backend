...
const AP_ROUNDS = parseInt(process.env.AP_ROUNDS)
const APP_SECRET = process.env.APP_SECRET

const hashPassword = async (password) => {
  // Accepts a password from the request body
  let hashedPassword = await bcrypt.hash(password, AP_ROUNDS)
  //   Creates a hashed password and encrypts it 9 times
